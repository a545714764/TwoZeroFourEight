...
public class Number64 extends JPanel {
	...
	protected void paintComponent(Graphics arg0) {
		...
		Image bgImg = null;
		 try {
			 bgImg = ImageIO.read(new File("TwoZeroFourEight/src/image/64.png"));
		 } catch (IOException e) {
			 e.printStackTrace();
		 }
